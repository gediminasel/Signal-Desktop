        ...
        {measureRef => (
          ...
          >
            ...
            <HeaderMenu
              ...
              onConversationJumpToDate={onConversationJumpToDate}
...
function HeaderMenu({
  ...
  const jumpToDateRef = useRef<HTMLInputElement>(null);
      ...
      {conversation.acceptedMessageRequest && (
        <>
          ...
          <MenuItem
            ...
            onClick={() => {
              (
                jumpToDateRef.current as unknown as {
                  showPicker: () => void;
                }
              )?.showPicker();
            }}
          >
            ...
            <input
              ...
              onChange={e => {
                ...
                onConversationJumpToDate(localDate.getTime());
              }}
              ref={jumpToDateRef}
            />
          </MenuItem>
